...
var Login = /** @class */ (function (_super) {
    ...
    Login.prototype.redirects = function () {
        if (this.props.authStatus) {
        ...
        if (this.props.pathname === "/restore-password-session" &&
    ...
    Login.prototype.style = function () {
    ...
    Login.prototype.form = function () {
        var _this = this;
        return (react_1["default"].createElement(semantic_ui_react_1.Form, { size: "large", onSubmit: function () {
                _this.formSubmit();
            } },
            react_1["default"].createElement(semantic_ui_react_1.Segment, { stacked: true },
                ...
                react_1["default"].createElement(react_router_dom_1.Switch, null,
                    react_1["default"].createElement(react_router_dom_1.Route, { path: "/registration", render: function () {
                            var errorMessageRegistration = _this.state.errorMessageRegistration;
    ...
    Login.prototype.formSubmit = function () {
        ...
        if (this.props.pathname === "/registration") {
            ...
            if (this.loginFormValidate()) {
                var _b = this.state, email = _b.email, password = _b.password;
