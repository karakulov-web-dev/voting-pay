...
var registrationUser_1 = require("../../src/actions/registrationUser");
describe("actions/registrationUser", function () {
    describe("registrationUser(email: string,password: string)", function () {
        it("should dispatch RegistrationUserResultAction", function (done) {
            function registrationUserCheck(email, password) {
            ...
            var thunk = registrationUser_1.registrationUserFlex("email@test", "passTest", registrationUserCheck);
        ...
        it("RegistrationUserResultAction payload AccessTokenmust be equivalent registrationUserCheck result(AccessToken)", function (done) {
            var registrationUserCheckResult = {
                AccessToken: "1",
                errorStatus: false,
                errorText: ""
            };
            function registrationUserCheck(email, password) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, registrationUserCheckResult];
                    });
                });
            }
            var thunk = registrationUser_1.registrationUserFlex("email@test", "passTest", registrationUserCheck);
            ...
            var dispatch = function (result) {
                var status = true;
                if (result.payload.AccessToken !== registrationUserCheckResult.AccessToken) {
                    status = false;
                }
                if (status) {
                    done();
